...
typedef NS_ENUM (NSInteger,IJKPlayType){
    /// 点播
    IJKPlayTypeOrder = 0,
    /// 直播
    IJKPlayTypeLive
...
IJK_EXTERN NSString *const IJKMPMoviePlayerGetSeiContent;
IJK_EXTERN NSString *const IJKMPMoviePlayerUserInfoKeyGetSeiContent;
